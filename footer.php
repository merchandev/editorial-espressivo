            ...
            <div class="footer-grid">
                <div class="footer-about">
                    ...
                    if ( has_nav_menu( 'footer' ) ) {
                        ...
                        echo '<li><a href="#">Vital 101.5 | Señal en vivo</a></li>';
                        echo '<li><a href="#">Grupo de WhatsApp</a></li>';
                        echo '<li><a href="#">Google Noticias</a></li>';
                        echo '<li><a href="#">Relevantes</a></li>';
                        echo '</ul>';
                    }
                    ?>
                </div>
                ...
                <div class="footer-social-section">
                    ...
                    <div class="social-icons">
                        <a href="<?php echo esc_url( get_theme_mod('pro_social_facebook', '#') ); ?>" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                        ...
                        <a href="<?php echo esc_url( get_theme_mod('pro_social_instagram', '#') ); ?>" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <a href="#" class="btn-footer-denuncia"><span class="material-symbols-outlined">report</span> Envía tu denuncia</a>
                </div>
            </div>
        </div><!-- .footer-widgets -->
