        ...
        <div class="footer-widgets container">
            <div class="footer-grid">
                ...
                <div class="footer-social-section">
                    <h3 style="font-family: var(--font-ui); font-size: 1.1rem; font-weight: bold; margin-bottom: 20px; text-transform: uppercase;">Redes Sociales</h3>
                    <div class="social-icons" style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
                        <a href="<?php echo esc_url( get_theme_mod('pro_social_facebook', '#') ); ?>" target="_blank" rel="noopener noreferrer" style="background: #ffffff; color: #1e293b; width: 36px; height: 36px; display: inline-flex; align-items: center; justify-content: center; border-radius: 4px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--color-primary)'; this.style.color='#ffffff'; this.style.transform='translateY(-3px)'" onmouseout="this.style.background='#ffffff'; this.style.color='#1e293b'; this.style.transform='none'" aria-label="Facebook">
                        ...
                        <a href="<?php echo esc_url( get_theme_mod('pro_social_twitter', '#') ); ?>" target="_blank" rel="noopener noreferrer" style="background: #ffffff; color: #1e293b; width: 36px; height: 36px; display: inline-flex; align-items: center; justify-content: center; border-radius: 4px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--color-primary)'; this.style.color='#ffffff'; this.style.transform='translateY(-3px)'" onmouseout="this.style.background='#ffffff'; this.style.color='#1e293b'; this.style.transform='none'" aria-label="Twitter X">
                            <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>
                        <a href="<?php echo esc_url( get_theme_mod('pro_social_instagram', '#') ); ?>" target="_blank" rel="noopener noreferrer" style="background: #ffffff; color: #1e293b; width: 36px; height: 36px; display: inline-flex; align-items: center; justify-content: center; border-radius: 4px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--color-primary)'; this.style.color='#ffffff'; this.style.transform='translateY(-3px)'" onmouseout="this.style.background='#ffffff'; this.style.color='#1e293b'; this.style.transform='none'" aria-label="Instagram">
                        ...
                        <a href="#" target="_blank" rel="noopener noreferrer" style="background: #ffffff; color: #1e293b; width: 36px; height: 36px; display: inline-flex; align-items: center; justify-content: center; border-radius: 4px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--color-primary)'; this.style.color='#ffffff'; this.style.transform='translateY(-3px)'" onmouseout="this.style.background='#ffffff'; this.style.color='#1e293b'; this.style.transform='none'" aria-label="WhatsApp">
